...
class Test:
    ...
    def cut_image(IMG_SIZE, x_bounds, y_bounds, X_CUT, Y_CUT,full_img):
    ...
    def CarsInTheSky(imageName):
        ...
        model = load_model(os.path.join(dir,model_name), compile = False)
        IMG_SIZE = model.input_shape[1]


        # get bounds
        x_bounds, y_bounds = Test.get_bounds(IMG_SHAPE, X_CUT, Y_CUT)
        
        # cut image
        img_array = Test.cut_image(IMG_SIZE, x_bounds, y_bounds, X_CUT, Y_CUT,full_img)
        # get X_test
        X_test = Test.get_test_data(img_array)
...
>>>>>>> db61d6500f4d2f0390530d33266be34f89c866e8
